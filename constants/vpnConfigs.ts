// Complete VPN server configurations with authentication
...
// Authentication credentials for all servers
export const VPN_AUTH = {
  username: 'vpnbook',
  password: 'm34wk9w',
};

// Server priority for auto-fallback (UDP first, then TCP)
export const CONNECTION_PRIORITY = [
  'canada-udp-53',      // Priority 1: Fastest
  'canada-udp-25000',   // Priority 2: Fast
  'canada-tcp-443',     // Priority 3: Reliable
  'canada-tcp-80',      // Priority 4: Backup
];